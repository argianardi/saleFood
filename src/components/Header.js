...
const Header = () => {
  ...
  const blurBackgroundHandler = () => {
    if (window.scrollY >= 140) {
      setBlurBackground('border-b-[1px] border-gray-lighter');
    } else {
      setBlurBackground('');
    }
  };
  ...
  return (
    <>
      {/* Sidebar handler */}
      <div
        className={`${blurBackground} sticky top-0 z-50 block bg-white xl:hidden`}
      >
            ...
            <ul>
              ...
              <li className="mt-4">
                <a href="/#" className="flex items-center group">
                  ...
                  <span className="ml-3 text-sm font-semibold transition-all duration-300 font-quicksand text-gray-light group-hover:text-blue-dark group-hover:font-bold">
                    Dashboard
                  </span>
