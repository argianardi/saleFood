...
const Header = () => {
  ...
  const showBorderHandler = () => {
    if (window.scrollY >= 140) {
      setShowBorder('border-b-[1px] border-gray-lighter');
    } else {
      setShowBorder('');
    }
  };

  window.addEventListener('scroll', showBorderHandler);

  const navbarActivationHandler = (buttonId) => {
    setActiveNavbar(buttonId);
  };

  const navActivationHandler = (nav) => {
    setActiveNav(nav);
  };
  ...
  return (
    <>
      <div
        className={`${showBorder} sticky top-0 z-50 block bg-white xl:hidden`}
      >
          ...
          <div className="flex items-center">
            ...
            >
              ...
              <path
                ...
                fillOpacity="0.1"
                mask="url(#path-1-inside-1_1_205)"
              />
              <defs>
                <linearGradient
            ...
            <h1 className="ml-1 text-[28px] font-bold text-blue-dark font-quicksand">
              square
            </h1>
          </div>
          <button
        ...
        >
          ...
          <nav className="-mt-12">
            <ul>
              <li>
                <h2 className="font-inter text-[10px] text-gray-light mt-6">
                  {' '}
                  Menu
                </h2>
              </li>
              <li className="mt-4">
                <button
                  onClick={() => navActivationHandler('dashboard')}
                  type="button"
                ...
                >
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'dashboard' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeMiterlimit="10"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <span
                    className={`ml-3 text-sm font-semibold transition-all duration-300 font-quicksand ${
                      activeNav === 'dashboard'
                        ? 'text-blue-dark'
                        : 'text-gray-light'
                    } group-hover:text-blue-dark group-hover:font-bold`}
                  >
                    Dashboard
                  </span>
                  <span className="font-quicksand text-[10px] font-semibold text-white bg-gradient-to-r from-[#EEA849] to-[#F46B45] px-[6px] py-[1px] ml-8 rounded-full">
                    4
                  </span>
                </button>
              </li>
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('stockMenu')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'stockMenu' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('customer')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      fill={`${
                        activeNav !== 'customer' ? '#98949E' : '#5D5FEF'
                      }`}
                      stroke={`${
                        activeNav !== 'customer' ? '#98949E' : '#5D5FEF'
                      }`}
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('restaurant')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'restaurant' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('design')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'design' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('report')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'report' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeMiterlimit="10"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('role&admin')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'role&admin' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('settings')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'setings' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeMiterlimit="10"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <ul>
              <li>
                <h3 className="font-inter text-[10px] text-gray-light mt-8">
                  Integration
                </h3>
              </li>
              <li className="mt-4">
                <button
                  onClick={() => navActivationHandler('stockIntegration')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'stockIntegration' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeMiterlimit="10"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <li className="mt-7">
                <button
                  onClick={() => navActivationHandler('supply')}
                  type="button"
                  className="flex items-center group"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      stroke={`${
                        activeNav !== 'supply' ? '#98949E' : '#5D5FEF'
                      }`}
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
          ...
          <div className="flex border-t-[1px] border-gray-lighter py-6 pl-5 -ml-2 w-ful -mr-2 mt-28">
            <figure className="rounded-full avatar w-9 h-9">
              <img src={avatar} alt="avatar" />
            </figure>
            <div>
              <div className="ml-3">
                <h3 className="text-sm font-semibold font-quicksand text-black-lighter">
                  Savannah N
                </h3>
                <h5 className="text-[10px] font-inter font-normal text-gray-light">
                  Food Quality
                </h5>
              </div>
              <button
                type="button"
                className="flex py-1 mt-8 duration-300 transform rounded-sm hover:bg-gray-200"
              >
                <svg
                  width="16"
                  height="16"
                ...
                <span className="ml-2 text-xs font-semibold font-quicksand text-red-dark">
                  Logout
                </span>
              </button>
            </div>
      ...
      <header className="h-auto flex flex-col md:flex-row items-end justify-between xl:h-28 body-oke border-b-[1px] border-gray-lighter">
        <div className="flex flex-col justify-center w-full h-full mt-3 xl:mt-6 md:w-auto">
