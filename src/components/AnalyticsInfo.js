...
const AnalyticsInfo = () => {
  return (
    <div className="relative w-full h-[265px] xs:h-[400px] min-[500px]:h-[500px] sm:h-[595px] 2xl:w-[227px] lg:h-[265px] bg-blue-dark rounded-lg overflow-hidden">
      <svg
      ...
      <div className="absolute top-4 xs:top-36 lg:top-4 left-4 2xl:w-40 h-[90px]">
        <p className="text-xl font-semibold text-white font-quicksand">
          See analytics of the Customer Clearly
        </p>
      </div>
      <div className="z-10 absolute w-[323px] h-[323px] bg-blue-dark rounded-full border-[1px] border-purple-light left-[84px] top-[106px] xs:top-[251px] lg:top-[106px]" />
      <div className="z-10 absolute w-[323px] h-[323px] bg-purple-dark border-[1px] border-white top-[136px] xs:top-[300px] lg:top-[136px] left-[126px] rounded-full" />
      <div className="z-10 absolute w-[323px] h-[323px] top-[166px] xs:top-[330px] lg:top-[166px] left-[168px] rounded-full bg-purple-light border-[1px] border-gray-lightest" />
      <button
        type="button"
