...
const Hero = () => {
  return (
    <div className="h-[167px] relative bg-blue-dark rounded-lg overflow-hidden w-[950px]">
      <img
        src={hero}
        alt="hero"
        className="absolute right-0 z-10 object-cover object-center h-full"
      />
      <div className="absolute z-40 flex flex-col justify-between w-full h-full p-3">
        ...
        <div className="flex items-center justify-between">
          <div>
            <button
              type="button"
              className="flex items-center px-4 py-3 rounded-lg blur-filter bg-white/20 hover:bg-white/40"
            >
          ...
          <div className="flex items-center justify-between py-1 pl-4 pr-1 bg-white rounded-lg bg-gradient-to-r from-white via-white-25 to-white-25 w-[424px]">
            <form className="flex items-center text-gray-400">
              ...
              <input
                ...
                className="px-2 py-1 text-sm font-medium bg-transparent focus:outline-none font-quicksand text-gray-lighter placeholder:text-gray-lighter placeholder:font-quicksand placeholder:text-sm placeholder:font-medium"
              />
            </form>
            <button
              type="button"
              className="px-4 py-2 text-sm font-bold text-white rounded-lg bg-blue-dark hover:bg-blue-700 font-quicksand"
            >
              Search
            </button>
          </div>
          <div>
            <button
              type="button"
              className="flex items-center px-4 py-3 rounded-lg blur-filter hover:bg-white/40 bg-white/20"
            >
              <svg
                width="16"
                height="17"
